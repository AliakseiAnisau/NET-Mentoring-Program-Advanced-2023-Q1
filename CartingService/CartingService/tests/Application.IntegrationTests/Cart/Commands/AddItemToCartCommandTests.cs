...
using CartingService.Application.IntegrationTests;
using CartingService.Application.Carts.Commands.AddItemToCart;
using CartingService.Application.Common.Exceptions;

namespace CartingService.Application.IntegrationTests.Cart.Commands;
...
public class AddItemToCartCommandTests : BaseTestFixture
{
    ...
    public async Task ShouldCreateCart()
    {
        ...
        var cart = Find<CartingService.Domain.Entities.Cart>(id);
    ...
    public async Task ShouldAddItemToExistingCart()
    {
        ...
        var cart = Find<CartingService.Domain.Entities.Cart>(id1);
